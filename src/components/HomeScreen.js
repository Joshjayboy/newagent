    ...
    <>
      ...
      >
        ...
        <Box sx={{ mb: 5 }}>
          ...
          минут, расстояние составляет 38 км. В 5 минутах ходьбы от дома
          находится остановка общественного транспорта «ДК имени Строгалина»,
          откуда курсируют автобусы до станции «Пушкино» и ст. м. «ВДНХ». До
          Москвы можно добраться электричкой Ярославского направления от ж/д
          станции «Красноармейск», время в пути занимает 1 час 30 минут.
        </Box>
      </Box>
      {/* end of pure text */}
      {/* map */}
